...
def mcp_endpoint():
    server_info = {
        "name": "Quantrax Agent Server",
        "version": "1.0.0",
        "website": "https://quantrax-api.vercel.app",
...
def a2a_endpoint():
    return jsonify({
        ...
        "version": "1.0.0",
        "description": "Quantrax is a smart AI agent for easy data analysis. It helps you understand datasets, make charts, and forecast trends fast on the Base network",
        "services": [
            {
                "name": "MCP",
                "version": "2025-06-18",
                "endpoint": "https://quantrax-api.vercel.app/mcp",
                "transport": "http"
            },
            {
                "name": "A2A",
                "version": "0.3.0",
                "endpoint": "https://quantrax-api.vercel.app/.well-known/agent-card.json",
                "transport": "http"
            }
        ],
        "registrations": [
...
def oasf_endpoint():
    return jsonify({
        ...
        "name": "quantrax",
        "version": "v0.8.0",
        "description": "Main endpoint for Quantrax AI analytics",
        "website": "https://quantrax-api.vercel.app",
        "protocols": ["mcp","a2a"],
